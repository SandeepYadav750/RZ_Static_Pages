            ...
            <form class="flex flex-col gap-y-6">
                ...
                <div>
                    <span class="p-float-label">
                        <InputText id="mobileNumber" v-model="value" class="w-full" />
                        <label for="mobileNumber">Username</label>
                    </span>
                    <span class="text-xs font-semibold text-[#086b3b]">Please Enter Valid 10 digit Telephone Number with STD
                        code (without 0)</span>
                </div>
                <Button :pt="{
...
const operators = ref([
    { name: 'ACT Fibernet' },
    { name: 'Activline Telecom Private Limited' },
    { name: 'Air Connect' },
