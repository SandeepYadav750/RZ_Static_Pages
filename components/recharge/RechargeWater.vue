            ...
            <form class="flex flex-col gap-y-6">
                ...
                <div>
                    <span class="p-float-label">
                        <InputText id="serviceNumber" v-model="value" class="w-full" />
                        <label for="serviceNumber">Service Number</label>
                    </span>
                    <span class="text-xs font-semibold text-[#086b3b]">Please enter a valid service No (eg. BHO45621)</span>
                </div>
                <Button :pt="{
...
const operators = ref([
    ...
    { name: 'Bhiwadi - Urban Improvement Trust (UIT)' },
    ...
    { name: 'Pune Municipal Corporation - (PMC) -Water' },
    { name: 'ETC' }
]);
</script>
